========================================================================
    コンソール アプリケーション: GettingStartedGuide プロジェクトの概要
========================================================================

この GettingStartedGuide アプリケーションは、AppWizard により作成されました。

このファイルには、GettingStartedGuide 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


GettingStartedGuide.vcxproj
...
GettingStartedGuide.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、GettingStartedGuide.pch 
